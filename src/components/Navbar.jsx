...
export const Navbar = () => {
  ...
  return (
   <div className='max-w-[1640px] mx-auto flex justify-between items-center p-2 flex-wrap gap-6'>
    ...
    <span className='font-bold'>Eat</span></h1>
   {/* Side text */}
   ...
   {/* Side text end here */}
    ...
    {/* Search Input */}
        <div  className='bg-gray-300 rounded-full flex  mx-auto items-center px-2 w-[300px]  sm:w-[400px]  lg:w-[500px]'>
        ...
        { nav ? <div className='bg-black/80 fixed w-full h-screen z-10 top-0 left-0'></div> : ""}
         ...
         {/* Side drawer menu */}
         <div className={nav ? "fixed top-0 left-0 w-[250px] h-screen bg-white z-10 duration-300" :"fixed top-0 left-[-120%] w-[250px] h-screen bg-white z-10 duration-300"}>
            <AiOutlineClose
            onClick={()=> setNav(!nav)}
            size={30} className='absolute right-4 top-3 cursor-pointer'/>
